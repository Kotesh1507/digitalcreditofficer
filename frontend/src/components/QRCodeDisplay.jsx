...
// Replace with your actual lead capture URL
const LEAD_CAPTURE_URL = import.meta.env.VITE_LEAD_CAPTURE_URL || 'https://yourdomain.com/pilot';
    ...
    >
      ...
      <div>
        <div className="text-sm font-semibold text-white mb-0.5">
          Want to run this on your borrowers?
        </div>
